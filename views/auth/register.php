    ...
    <div class="auth-wrapper">
        <div class="auth-card">
            ...
            <form method="POST" action="">
                ...
                <button type="submit" class="btn btn-primary" style="width: 100%; font-weight: 600;">Sign Up</button>
            </form>
            
            <div class="switch-auth">
                Already have an account? <a href="/ucms_new/views/auth/login.php">Login</a>
            </div>
        </div>
    </div>
</body>
